...
- [x] **三个任务**: 章节生成、给边界生成标题、章节定位
- [x] **迁移学习**: 预训练后在 YouCook2/ViTT 上提升 SOTA
...
### 我的疑问
- [x] 为什么用户会主动标注章节？→ YouTube 2020 年推出章节功能，创作者为了提升观看体验
- [ ] 爬取的章节质量如何保证？→ 后续 Section 3.3 会分析
