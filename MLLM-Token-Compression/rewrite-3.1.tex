...
Tethered to a single-indicator paradigm, existing visual token pruning methods rest on an assumption that has not been systematically examined: a single importance criterion suffices to separate indispensable tokens from expendable ones.
