...
Tethered to a monolithic indicator paradigm, existing visual token pruning methods rest upon an assumption that has eluded systematic scrutiny: a single importance criterion suffices to separate indispensable tokens from expendable ones.
