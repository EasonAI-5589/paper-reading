...
A foundational yet rarely scrutinized premise pervades the visual token pruning literature: that a single importance indicator can reliably separate indispensable tokens from expendable ones.
