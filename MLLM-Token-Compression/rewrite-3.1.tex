...
VisionZip, guided by ViT CLS attention, primarily retains foreground tokens of high semantic saliency---a selection that remains invariant to the user's query.
