...
To be specific, we quantify this divergence by measuring the pairwise overlap of selected token sets across methods at varying retention levels.
Methods sharing the same indicator family exhibit moderate concordance---for instance, VisionZip and SCOPE, both grounded in CLS-based saliency, achieve an overlap of 0.64 at $K{=}128$.
