...
Existing visual token pruning methods share a pervasive yet unexamined assumption: a single importance criterion suffices to separate indispensable tokens from expendable ones.
